        ...
        <div class="col-md-4">
            <div class="card sticky-top" style="top: 20px;">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="table_id" class="form-label">Mesa (Opcional)</label>
                        <select class="form-select <?= isset($errors['table_id']) ? 'is-invalid' : '' ?>" 
                                id="table_id" 
                                name="table_id">
                            <option value="">Sin mesa asignada (para llevar o asignación posterior)</option>
                        ...
                        <?php endif; ?>
                        <div class="form-text">
                            Puede dejar sin mesa para pedidos de llevar o asignación posterior por el personal
                        </div>
                    </div>
                            ...
                            <div class="card dish-card h-100" data-dish-id="<?= $dish['id'] ?>">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        ...
                                        <span class="badge bg-success fs-4 fw-bold price-highlight">$<?= number_format($dish['price'], 2) ?></span>
                                    </div>
